...
urlpatterns = [
    ...
    path('calendar/m<int:curMonth>d<int:curDay>y<int:curYear>/body/delete/', views.calendarBodyDelete, name='daybody_delete'),
    path('accounts/signup/', views.signup, name="signup"),
    path('foods/', views.foodIndex, name="foods_list"),
